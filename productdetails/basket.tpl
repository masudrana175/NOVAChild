                ...
                {if !$showMatrix}
                    {block name='productdetails-basket-form-inline'}
                        {row class="basket-form-inline"}
                            {$basketColWidth = 6}
                            {* Konfigurator-Standard: volle Breite; Buybox-Preview (?v=cfg): wie normale Artikel nebeneinander *}
                            {if $Artikel->bHasKonfig && empty($beautekCfgPills)}
                                {$basketColWidth = 12}
                            {/if}
                            ...
                            {block name='productdetails-basket-add-to-cart'}
                                {col cols=12 sm=$basketColWidth}
                                    {button aria=["label"=>"{lang key='addToCart'}"]
                                        ...
                                        <svg x="0px" y="0px" width="32px" height="32px" viewBox="0 0 32 32" role="img" aria-label="{lang key='success' section='aria'}">
