...
{block name='layout-header-shop-nav-wish-link'}
    {link class='nav-link' aria=['expanded' => 'false', 'label' => {lang key='wishlist'}, 'controls'=>'nav-wishlist-collapse'] data=['toggle' => 'dropdown'] role='button'}
        {literal}
        ...
        <i class="fas fa-heart" title="{lang key='wishlist'}">
