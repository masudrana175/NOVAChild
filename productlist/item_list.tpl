                    ...
                    {block name='productlist-item-list-title'}
                        {block name='productlist-item-list-title-heading'}
                            <div class="productbox-title beautek-productbox-title js-beautek-card-title" itemprop="name">
                                {link href=$productHref data=["full-name"=>$Artikel->cName]}
                                    {$Artikel->cName}
                                {/link}
                            </div>
                        ...
                        {form id="{$idPrefix|default:''}buy_form_{$Artikel->kArtikel}"
                            ...
                            {row}
                                ...
                                {col cols=12 xl=4 class='productbox-variations'}
                                    {* Varianten-Hover in Listenansicht ausgeblendet – Swatches im Titelbereich *}
                                {/col}
                                            ...
                                            {else}
                                                {col cols=12}
                                                    {block name='productlist-item-list-basket-details-details'}
                                                        {link class="btn btn-outline-primary btn-block" role="button" href=$productHref}
                                                            {lang key='details'}
                                                        {/link}
                                                    {/block}
                                                {/col}
